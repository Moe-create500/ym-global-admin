...
export default function ZenchoicePage() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-white">Zenchoice</h1>
          <p className="text-slate-400 text-sm mt-1">Wellness & lifestyle brand</p>
        </div>
        {store && (
          <Link
