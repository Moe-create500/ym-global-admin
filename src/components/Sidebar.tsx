...
const ADMIN_NAV: NavGroup[] = [
  ...
  { section: 'P&L', items: [
    ...
    { href: '/dashboard/bulk-upload', label: 'Reconciliation', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12' },
  ...
  { section: 'Finance', items: [
    ...
    { href: '/dashboard/transactions', label: 'The Brain', icon: 'M12 4a4 4 0 00-4 4v.5A3.5 3.5 0 005 12a3.5 3.5 0 001.5 2.9V16a4 4 0 004 4h3a4 4 0 004-4v-1.1A3.5 3.5 0 0019 12a3.5 3.5 0 00-3-3.5V8a4 4 0 00-4-4z' },
  ...
  { section: 'Management', items: [
    { href: '/dashboard/foundation', label: 'Foundation', icon: 'M3 21h18M4 18h16M6 18V9m4 9V9m4 9V9m4 9V9M2 9l10-5 10 5' },
