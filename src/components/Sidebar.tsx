...
const nav = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/credit-cards', label: 'Credit Cards', icon: 'M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/employee', label: 'Employee Portal', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-56 bg-slate-900 border-r border-slate-800 flex flex-col z-40 hidden lg:flex">
      ...
      <div className="px-5 py-5 border-b border-slate-800">
        <h1 className="text-lg font-bold text-white">YM Global</h1>
        <p className="text-[11px] text-slate-500 mt-0.5">Enterprise Ventures</p>
      </div>
